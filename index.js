...
// -- The consonant substrings are: "str" and "ngth" with values "str" = 19 + 20 + 18 = 57 and "ngth" = 14 + 7 
// + 20 + 8 = 49. The highest is 57.

const solve = (str) => {    
    let arr = str.split(/[aeiou]/)
    arr = arr.map((word) => word.split("").reduce((a,b)  => a + (b.charCodeAt(0) - 97 + 1), 0))
    return Math.max(...arr)
}
